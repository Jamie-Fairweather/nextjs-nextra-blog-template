...
export const mdxComponents = {
    ...
    Image: ({
        ...
        // If width/height are provided, use Next.js Image for optimization
        if (width && height) {
            return (
                <NextImage
        ...
        // Otherwise, use regular img tag for flexibility
        // This is useful for images where dimensions aren't known or for external images
        return (
            // eslint-disable-next-line @next/next/no-img-element
            <img className={cn('mt-6 h-auto max-w-full rounded-md border', className)} src={(src as string) || ''} alt={alt || ''} {...props} />
        )
    },
